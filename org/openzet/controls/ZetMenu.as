...
import org.openzet.controls.menuClasses.MenuItemRenderer;
...
public class ZetMenu extends mx.controls.Menu
{
     ...
     */
    public static function createMenu(parent:DisplayObjectContainer, mdp:Object, showRoot:Boolean = true):org.openzet.controls.ZetMenu
    {
        var menu:org.openzet.controls.ZetMenu = new org.openzet.controls.ZetMenu();
     ...
     */
    public static function popUpMenu(menu:org.openzet.controls.ZetMenu, parent:DisplayObjectContainer, mdp:Object):void
    {
    ...
    {
        var target:org.openzet.controls.ZetMenu = this;

        while (target.parentMenu)
            target = org.openzet.controls.ZetMenu(target.parentMenu);
    ...
    {
        var menu:org.openzet.controls.ZetMenu = org.openzet.controls.ZetMenu(event.target);
    ...
    private function isMouseOverMenu(event:MouseEvent):Boolean
    {
        ...
        while (target)
        {
            if (target is org.openzet.controls.ZetMenu)
                return true;
    ...
    override mx_internal function openSubMenu(row:IListItemRenderer):void
    {
        ...
        {
            menu = org.openzet.controls.ZetMenu(IMenuItemRenderer(row).menu);
        }
        ...
        subMenu = org.openzet.controls.ZetMenu(menu);
        openSubMenuTimer = 0;
