...
/**
 *  The skin for all the states of SearchBox.
 */
public class SearchBoxArrowSkin extends Border
{
	 ...
	 *  Constructor.
	 */
	public function SearchBoxArrowSkin()
	{
		super();
	}
	...
	override protected function updateDisplayList(w:Number, h:Number):void
	{
		...
		g.endFill();
		*/
		g.moveTo(w/2 - 0.5, h / 2 + 3);
		g.lineTo(w/2 - 4, h / 2 - 2);
		g.lineTo(w/2+3, h / 2 - 2);
		g.lineTo(w/2 - .5, h / 2 + 3);
		g.endFill();
	}
}
