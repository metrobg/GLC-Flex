package com.metrobg.Classes {
    ...
    public class FileDownload extends UIComponent {
        ...
        //private const DOWNLOAD_URL:String = "http://www.goodlifecredit.com/exports/merge.txt";
        private const DOWNLOAD_URL:String = "http://www.goodlifecredit.com/flex/Data/";
        private var DL_File:String = "merge.txt";
        ...
        public function startDownload():void {
            ...
            request.url = DOWNLOAD_URL + DL_File + "?"+  NumberUtilities.getUnique();
            fr.download(request);
        }
